...
import 'monaco-editor/editor/standalone/browser/quickInput/standaloneQuickInputService.js';
...
export declare const editor1: any;
export declare const editor2: any;
